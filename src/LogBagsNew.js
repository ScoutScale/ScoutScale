...
export const LogBags = ({ authCode }) => {
    ...
    const [showAdditionalInfo, setShowAdditionalInfo] = useState(false); // State variable to track if additional info should be shown
                ...
                <div>
                    ...
                    <div className="flex items-center flex-col flex items-center">
                        ...
                        <div className="text-center w-full">
                            ...
                            <button onClick={() => {setnumBags(4); setShowAdditionalInfo(true);}}
